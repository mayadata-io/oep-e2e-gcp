...
<b>tcid:</b> iuod30 <br>
<b>name:</b> "Upgrade the application with 3 replicas when all replica pod is not running"<br>
...
<table>
  ...
  <tr>
    ...
    <td> Upgrade the application with 3 replicas when all replica pod is not running </td>
    <td> GKE </td>
  </tr>
</table>
...
- Now create some scenario so that all the application volume replica pod should go into pending state .
